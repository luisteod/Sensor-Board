...
uint16_t dataBlock[] =
{
    0x1555, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007,
...
{
    uint16_t teste = 0;
    if(FLASH_ReadWord(0x0780) != 0x1555)
    {

        uint8_t flag = FLASH_WriteBlock(0x0780, dataBlock);

    }
    teste = FLASH_ReadWord(0x0780);
    teste++;
}
