...
const uint8_t status_in_flash[8] __attribute__((address(0x680)));
const uint8_t default_in_flash[72] __attribute__((address(0x688)));
...
# 49 "mcc_generated_files/mcc.c" 2
