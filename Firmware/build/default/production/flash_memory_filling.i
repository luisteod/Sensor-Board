...
void memory_initialize(uint8_t TAG)
{
    ...
    if(FLASH_ReadWord(0x780) != 0x55)
    {
        ...
        FLASH_WriteWord(0x780 + 2, ramBuff, (uint16_t)default_in_flash[TAG - 1][0]);
        FLASH_WriteWord(0x780 + 3, ramBuff, (uint16_t)default_in_flash[TAG - 1][1]);
        FLASH_WriteWord(0x780 + 4, ramBuff, (uint16_t)default_in_flash[TAG - 1][2]);
