# 1 "mcc_generated_files/sensor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/sensor.c" 2
# 27 "mcc_generated_files/sensor.c"
# 1 "mcc_generated_files/sensor.h" 1
# 31 "mcc_generated_files/sensor.h"
...
# 31 "mcc_generated_files/sensor.h" 2
# 54 "mcc_generated_files/sensor.h"
uint8_t SensorBoardType_validation (uint8_t SensorBoardType);
# 27 "mcc_generated_files/sensor.c" 2
...
# 28 "mcc_generated_files/sensor.c" 2



uint8_t SensorBoardType_validation (uint8_t SensorBoardType)
{
    if(SensorBoardType>=1)
    {
        if(SensorBoardType<=12)
        {
            return(1);
        }
    }
